...
const translations = {
  "pt-BR": {
    ...
    "schedule.discard": "Descartar",
    "schedule.unsaved": "Alterações não salvas",
    ...
    "profiles.description": "Gerencie os domínios e horários de bloqueio para este perfil.",
    "profiles.nameLabel": "Nome do perfil",
    "profiles.namePlaceholder": "Ex: Trabalho, Games",
    "profiles.nameExists": "Já existe um perfil com este nome.",
    "profiles.nameRequired": "O nome do perfil é obrigatório.",
    "profiles.nameTooLong": "O nome do perfil deve ter no máximo 50 caracteres.",
    ...
    "profiles.pagination": "Página {current} de {total}",
    "profiles.paginationInfo": "Mostrando {start}–{end} de {total} perfis",
    "profiles.prevPage": "Anterior",
    "profiles.nextPage": "Próxima",
    "profiles.pageNumber": "Página {page}",
    ...
    "message.profileNameExists": "Já existe um perfil com este nome.",
  ...
  en: {
    ...
    "schedule.unsaved": "Unsaved changes",
    ...
    "profiles.description": "Manage domains and blocking schedules for this profile.",
    "profiles.nameLabel": "Profile name",
    "profiles.namePlaceholder": "e.g., Work, Gaming",
    "profiles.nameExists": "A profile with this name already exists.",
    "profiles.nameRequired": "Profile name is required.",
    "profiles.nameTooLong": "Profile name cannot exceed 50 characters.",
    ...
    "profiles.pagination": "Page {current} of {total}",
    "profiles.paginationInfo": "Showing {start}–{end} of {total} profiles",
    "profiles.prevPage": "Previous",
    "profiles.nextPage": "Next",
    "profiles.pageNumber": "Page {page}",
    ...
    "message.profileNameExists": "A profile with this name already exists.",
