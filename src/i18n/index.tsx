...
const translations = {
  "pt-BR": {
    ...
    "statistics.title": "Estatísticas de proteção",
    "statistics.description": "Tempo em que seu perímetro de foco esteve ativo.",
    "statistics.period": "Período",
    "statistics.periodAria": "Período das estatísticas",
    "statistics.profile": "Perfil",
    "statistics.profileAria": "Perfil das estatísticas",
    "statistics.allProfiles": "Todos os perfis",
    "statistics.period7": "Últimos 7 dias",
    "statistics.period30": "Últimos 30 dias",
    "statistics.period90": "Últimos 90 dias",
    "statistics.unavailableTitle": "Histórico indisponível",
    "statistics.unavailableDescription":
      "Instale a integração do sistema para começar a registrar seu histórico de foco.",
    "statistics.errorTitle": "Não foi possível carregar as estatísticas",
    "statistics.errorDescription": "Tente novamente em alguns instantes.",
    "statistics.retry": "Tentar novamente",
    "statistics.protectedTime": "Tempo protegido",
    "statistics.completedSessions": "Sessões concluídas",
    "statistics.emptyTitle": "Seu histórico está começando",
    "statistics.emptyDescription": "Quando a proteção estiver ativa, os dados aparecerão aqui.",
    "statistics.dailyProtection": "Proteção por dia",
    "statistics.periodRhythm": "Ritmo do período",
    "statistics.mostProtected": "Mais protegidos",
    "statistics.domains": "Domínios",
    "statistics.domain": "Domínio",
    "statistics.time": "Tempo",
    "statistics.sessions": "Sessões",
    "statistics.hourAbbreviation": "h",
    "statistics.minuteAbbreviation": "min",
  },
  en: {
    ...
    "statistics.title": "Protection statistics",
    "statistics.description": "Time your focus perimeter was active.",
    "statistics.period": "Period",
    "statistics.periodAria": "Statistics period",
    "statistics.profile": "Profile",
    "statistics.profileAria": "Statistics profile",
    "statistics.allProfiles": "All profiles",
    "statistics.period7": "Last 7 days",
    "statistics.period30": "Last 30 days",
    "statistics.period90": "Last 90 days",
    "statistics.unavailableTitle": "History unavailable",
    "statistics.unavailableDescription":
      "Set up the system integration to start recording your focus history.",
    "statistics.errorTitle": "Statistics could not be loaded",
    "statistics.errorDescription": "Try again in a few moments.",
    "statistics.retry": "Try again",
    "statistics.protectedTime": "Protected time",
