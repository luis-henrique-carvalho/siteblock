...
pub const HELPER_SOURCE: &str = include_str!("../../../scripts/siteblock-admin");
...
pub const BROWSER_BRIDGE_SOURCE: &str = include_str!("../../../scripts/siteblock-browser-bridge");
...
pub fn extract_all_to(target_dir: &Path) -> std::io::Result<()> {
    write_text_asset(&target_dir.join("siteblock-admin"), HELPER_SOURCE, 0o755)?;
    ...
    write_text_asset(&target_dir.join("siteblock-browser-bridge"), BROWSER_BRIDGE_SOURCE, 0o755)?;
